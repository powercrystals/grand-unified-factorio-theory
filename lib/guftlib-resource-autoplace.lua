-- this entire file exists to add a single parameter to use as a multiplier for ore rarity
-- was: region_size = tne(1024),
-- now: region_size = tne(1024 * (params.region_size or 1.0)),
-- nothing else has been changed from the one in lualib\resource-autoplace.lua
...
local function resource_autoplace_settings(params)
  ...
  local regular_spots = tne{
    ...
    arguments =
    {
      ...
      seed1 = tne(seed1),
      region_size = tne(1024 * (params.region_size or 1.0)),
