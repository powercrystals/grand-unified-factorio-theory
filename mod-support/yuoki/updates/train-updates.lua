...
set_yuoki_train_tier("y_wagon_trans","steam")
...
set_yuoki_train_tier("y_wagon_coal","diesel")
set_yuoki_train_tier("y_wagon_copper","diesel")
set_yuoki_train_tier("y_wagon_iron","diesel")
set_yuoki_train_tier("y_wagon_stone","diesel")
set_yuoki_train_tier("yir_2acw_3blocks","steam")
set_yuoki_train_tier("y_wagon_zement_gray","steam")
set_yuoki_train_tier("y_wagon_zement_white","steam")
set_yuoki_train_tier("yir_4acw_closed","diesel")
set_yuoki_train_tier("yir_4acw_coal","diesel")
set_yuoki_train_tier("yir_4acw_copper","diesel")
set_yuoki_train_tier("yir_4acw_iron","sdiesel")
set_yuoki_train_tier("yir_4acw_vc","diesel")
set_yuoki_train_tier("yir_4acw_wood","diesel")
set_yuoki_train_tier("yir_4acw_mun","diesel")
set_yuoki_train_tier("yir_4acw_tf","diesel")
set_yuoki_train_tier("yir_4acw_gold","diesel")
set_yuoki_train_tier("yir_4acw_stone","diesel")
set_yuoki_train_tier("yir_4acw_grey","diesel")
set_yuoki_train_tier("yir_4acw_oceanblue","diesel")
set_yuoki_train_tier("yir_4acw_purple","diesel")
set_yuoki_train_tier("yir_fw4_vc","diesel")
set_yuoki_train_tier("y_wagon_tank_blue","diesel")
set_yuoki_train_tier("y_wagon_tank_orange","diesel")
set_yuoki_train_tier("y_wagon_tank_orange","diesel")
set_yuoki_train_tier("yir_fw4a_tank_oil","diesel")
set_yuoki_train_tier("y_wagon_tank_blue","diesel")
set_yuoki_train_tier("y_wagon_tank_fm2","diesel")
set_yuoki_train_tier("y_wagon_tank_fm1","diesel")
...
set_yuoki_train_tier("yir_loco_fut_red","future")
set_yuoki_train_tier("yir_loco_del_KR","diesel")
set_yuoki_train_tier("y_loco_ses_std","steam")
set_yuoki_train_tier("yir_loco_sel_blue","steam")
...
set_yuoki_train_tier("y_loco_diesel_620","diesel")
set_yuoki_train_tier("y_loco_ses_red","steam")
set_yuoki_train_tier("yir_loco_fesw_op","diesel")
set_yuoki_train_tier("y_loco_fs_steam_green","steam")
set_yuoki_train_tier("y_loco_steam_wt450","steam")
...
-- Uranium Power
set_yuoki_train_tier("yir_cw_empty_4a","future")
set_yuoki_train_tier("yir_cw_flourit_4a","future")
set_yuoki_train_tier("yir_cw_trans_4a","future")
set_yuoki_train_tier("yir_cw_uran_4a","future")
...
set_yuoki_train_tier("yir_cw_4a_cellsu","future")
set_yuoki_train_tier("yir_cw_4a_urana","future")
set_yuoki_train_tier("yir_atom_header","future")
set_yuoki_train_tier("yir_atom_mitte","future")

-- Yuoki Industries
set_yuoki_train_tier("yir_cw_cargo_green","steam")
set_yuoki_train_tier("yir_cw_cargo_blue","steam")
set_yuoki_train_tier("z_yira_4a_cw_kisten","diesel")
set_yuoki_train_tier("z_yira_4a_cw_stuff1","diesel")
-- (y_3acw-T10K can't be made in-game?)
set_yuoki_train_tier("y_3acw_T10K","")
set_yuoki_train_tier("z_yira_4a_cw_kiste1","diesel")
set_yuoki_train_tier("z_yira_4a_cw_yigreen","diesel")
set_yuoki_train_tier("z_yira_4a_cw_gears","diesel")
set_yuoki_train_tier("z_yira_4a_cw_yiblue","diesel")
set_yuoki_train_tier("z_yira_4a_cw_energy","diesel")
set_yuoki_train_tier("z_yira_4a_cw_eb1","diesel")
set_yuoki_train_tier("z_yira_4a_cw_ziegelrot","diesel")
set_yuoki_train_tier("z_yira_6a_maai1","diesel")
set_yuoki_train_tier("z_yira_4a_cw_steel","diesel")
set_yuoki_train_tier("z_yira_4a_cw_ziegelgrau","diesel")
set_yuoki_train_tier("yir_us_cargo","steam")
...
set_yuoki_train_tier("yir_kr_green","steam")
set_yuoki_train_tier("yir_loco_steam_wt580of","steam")
set_yuoki_train_tier("yir_mre044","steam")
set_yuoki_train_tier("yir_usl","steam")
