...
if data.raw["recipe"]["yir_fuel_coks_recipe"] and data.raw["recipe"]["bi-coke-coal"] then -- angel's performs much worse than yuoki's; we're using angel's item so keeping to angel's balance
